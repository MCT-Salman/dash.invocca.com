...
export function translatePermission(permission) {
    ...
    const permissionMap = {
        ...
        // Hall Management
        'manage_halls': 'إدارة قاعة/صالة',
        'view_halls': 'عرض قاعة/صالة',
        'create_halls': 'إنشاء قاعة/صالة',
        'edit_halls': 'تعديل قاعات/صالات',
        'delete_halls': 'حذف قاعات/صالات',
        'view_hall_clients': 'عرض عملاء قاعة/صالة',
        'view_hall_complaints': 'عرض شكاوى قاعة/صالة',
        'manage_hall_templates': 'إدارة قوالب قاعة/صالة',
    ...
    const resourceMap = {
        ...
        'own_events': 'فعالياتي',
        'own events': 'فعالياتي',
        'hall_templates': 'قوالب قاعة/صالة',
        'hall templates': 'قوالب قاعة/صالة',
        'hall_clients': 'عملاء قاعة/صالة',
        'hall clients': 'عملاء قاعة/صالة',
        'hall_complaints': 'شكاوى قاعة/صالة',
        'hall complaints': 'شكاوى قاعة/صالة',
        'templates': 'القوالب',
        'template': 'القوالب',
    }
