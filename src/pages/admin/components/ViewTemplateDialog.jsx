...
import { X, Tag, FileText, Calendar, CheckCircle, XCircle, Expand, ZoomIn, ZoomOut, RotateCw } from 'lucide-react'
...
export default function ViewTemplateDialog({ open, onClose, template }) {
    ...
    return (
        <>
            ...
            >
                <MuiBox sx={{ position: 'relative', width: '100%', height: '95vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    {/* Close Button */}
                    <MuiIconButton
                        onClick={() => {
                            setShowImagePreview(false)
