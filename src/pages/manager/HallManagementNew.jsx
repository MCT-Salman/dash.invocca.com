...
import { getManagerHall, updateHallInfo, getStaff } from '@/api/manager'
...
export default function HallManagement() {
    ...
    const staff = Array.isArray(staffData?.staff) ? staffData.staff : Array.isArray(staffData) ? staffData : []
